...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <nav class="navbar" data-spy="affix" style="background-color: #433C3C;">
                <div class="container">
                ...
                <div id="myCarousel" class="carousel slide self-align-items" role="dialog" data-ride="carousel" data-pause="hover" data-keyboard="true"> 
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/ex1.svg" class="d-block w-100"  alt="..."  style="width: 1450px; height: 525px;"> 
                        ...
                        <div class="carousel-item">
                            <img src="img/ex2.svg" class="d-block w-100"  alt="..."  style="width: 1450px; height: 525px;"> 
                            <div class="carousel-caption">
                                <h3>Teste 2</h3>
                                <p>Teste 2</p>
                            </div> 
                        ...
                        <div class="carousel-item">
                            <img src="img/ex3.svg" class="d-block w-100"  alt="..."  style="width: 1450px; height: 525px;"> 
                            <div class="carousel-caption">
                                <h3>Teste 3</h3>
                                <p>Teste 3</p>
                            </div> 
